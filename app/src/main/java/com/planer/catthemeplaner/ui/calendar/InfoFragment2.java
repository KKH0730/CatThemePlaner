...
public class InfoFragment2 extends Fragment {
    @BindView(R.id.informationLayout2)
    ConstraintLayout informationLayout2;
    ...
    public void setCustomTheme() {
        ...
        if (!themeName.equals("noTheme")) {
            if (themeName.equals("기본테마")) {
                informationLayout2.setBackgroundColor(getResources().getColor(R.color.mainColor));
            } else if (themeName.equals("첫번째")) {
                informationLayout2.setBackgroundColor(getResources().getColor(R.color.colorOrange));
            } else if (themeName.equals("두번째")) {
                informationLayout2.setBackgroundColor(getResources().getColor(R.color.colorYellow));
            } else if (themeName.equals("세번째")) {
                informationLayout2.setBackgroundColor(getResources().getColor(R.color.colorGreen));
            } else if (themeName.equals("네번째")) {
                informationLayout2.setBackgroundColor(getResources().getColor(R.color.colorPink));
            }
        }
    }
}
