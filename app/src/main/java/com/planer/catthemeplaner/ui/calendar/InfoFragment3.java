...
public class InfoFragment3 extends Fragment {
    @BindView(R.id.informationLayout3)
    ConstraintLayout informationLayout3;
    ...
    public void setCustomTheme() {
        ...
        if (!themeName.equals("noTheme")) {
            if (themeName.equals("기본테마")) {
                informationLayout3.setBackgroundColor(getResources().getColor(R.color.mainColor));
            } else if (themeName.equals("첫번째")) {
                informationLayout3.setBackgroundColor(getResources().getColor(R.color.colorOrange));
            } else if (themeName.equals("두번째")) {
                informationLayout3.setBackgroundColor(getResources().getColor(R.color.colorYellow));
            } else if (themeName.equals("세번째")) {
                informationLayout3.setBackgroundColor(getResources().getColor(R.color.colorGreen));
            } else if (themeName.equals("네번째")) {
                informationLayout3.setBackgroundColor(getResources().getColor(R.color.colorPink));
            }
        }
    }
}
